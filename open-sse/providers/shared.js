...
// ZCode client fingerprint & spoofing headers
export const ZCODE_APP_VERSION = "1.0.14";
export const ZCODE_APP_USER_AGENT = `ZCode/${ZCODE_APP_VERSION} (darwin-arm64)`;
export const ZCODE_CLIENT_HEADERS = {
  "User-Agent": ZCODE_APP_USER_AGENT,
  "x-client-name": "zcode",
  "x-client-version": ZCODE_APP_VERSION,
